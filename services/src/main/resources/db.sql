...
ALTER TABLE "timetable" ADD CONSTRAINT "timetable_fk1" FOREIGN KEY ("route_number") REFERENCES "route"("number");

ALTER TABLE "station" ADD CONSTRAINT "station_fk0" FOREIGN KEY ("stop_id") REFERENCES "stop"("id");
ALTER TABLE "station" ADD CONSTRAINT "station_fk1" FOREIGN KEY ("route_number") REFERENCES "route"("number");



ALTER TABLE "transport" ADD CONSTRAINT "transport_fk0" FOREIGN KEY ("driver_id") REFERENCES "driver"("id");
ALTER TABLE "transport" ADD CONSTRAINT "transport_fk1" FOREIGN KEY ("route_number") REFERENCES "route"("number");
