...
public class DriverDaoImpl extends GenericDaoImpl<Driver> implements IDriverDao {
	...
	private static final String SQL_GET_ALL_FREE_DRIVERS = "SELECT driver FROM driver EXCEPT SELECT driver FROM driver, transport WHERE transport.driver_id = driver.id";
	...
	public Long insert(final Driver entity) {
		...
		jdbcTemplate.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(final Connection connection) throws SQLException {
				...
				ps.setString(4, entity.getLicenseCategory());
				return ps;
			}
		}, keyHolder);
	...
	public void update(final Driver entity) {
		jdbcTemplate.update(SQL_UPDATE, new Object[] { entity.getFirstName(), entity.getLastName(),
				entity.getBirthday(), entity.getLicenseCategory(), entity.getId() });
	}
	...
	public List<Driver> getAllFreeDrivers() {
		final List<Driver> rs = jdbcTemplate.query(SQL_GET_ALL_FREE_DRIVERS, extractor);
		return rs;
	}
}
